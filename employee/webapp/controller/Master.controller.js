sap.ui.define([
	...
	return BaseController.extend("com.vysk.ui5appname.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.vysk.ui5appname.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("salary", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("salary", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
